...
const AddTrainHours = () => {
  ...
  const [unitClassOptions, setUnitClassOptions] = useState([]);
    ...
    const fetchInitialData = async () => {
      try {
        ...
        if (response.data.status) {
          ...
          console.log(classUnitArr);
          setClassUnitArr(classUnitArr); // simpan ke state!
          ...
          console.log('allCodeUnitArr:', codeUnitArr);

          setCodeOptions([]); // kosongkan dulu
        ...
        <CollapsibleCard title="Unit Info">
          ...
          <DropDownPicker
            ...
            setValue={val => {
              ...
              // Filter Class Unit sesuai type unit yang dipilih
              const filtered = classUnitArr.filter(
                item => item.class === val(),
              );
              setFilteredClassUnitOptions(filtered);
              // Reset Class Unit & Code jika Type Unit berubah
